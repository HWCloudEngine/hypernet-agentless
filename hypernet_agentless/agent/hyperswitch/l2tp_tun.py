...
class L2tpTUN(VPNDriver):
    ...
    def start_vpn(self, conn, br, vpn_nic_ip, br_nic):
        ...
        ## Connect NetNS to BR-NIC by veth pair
        veth_lns_peer="%s-01" % self.lns_name
        ...
        hu.netns_move_to(self.lns_name, veth2_lns_peer)
        ...
        ## Start xl2tpd
        hu.execute('ip', 'netns', 'exec', self.lns_name,
                    '/usr/sbin/xl2tpd',
...
require authentication = yes
        """
        options_l2tpd="""ipcp-accept-local
ipcp-accept-remote
mtu 1410
mru 1410
ms-dns 8.8.8.8
...
connect-delay 5000
        ...
        * * %s
        ...
        w.write(xl2tpd_conf % (self.f_xl2tpd_secret,
