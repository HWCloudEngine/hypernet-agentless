...
class HypernetManager(object):
    """Hypernet's Manager class.
    Hypernet's Manager class is responsible for parsing a config file and
    instantiating the correct plugin that concretely implement
    hypernet_plugin_base class.
    The caller should make sure that HypernetManager is a singleton.
    """
    _instance = None
    ...
    def load_class_for_provider(namespace, plugin_provider):
        ...
        try:
            return hs_utils.load_class_by_alias_or_classname(namespace,
                    plugin_provider)
        except ImportError:
    ...
    def _load_service_plugins(self):
        ...
        if hs_constants.HYPERSWITCH not in plugin_providers:
            plugin_providers.append(hs_constants.HYPERSWITCH)
        ...
        for provider in plugin_providers:
            ...
            plugin_inst = self._get_plugin_instance(
