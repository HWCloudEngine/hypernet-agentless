...
import hypernet_agentless.server.extensions

from hypernet_agentless._i18n import _
from hypernet_agentless.common import exceptions
from hypernet_agentless.server.api import policy
...
class RequestExtension(object):
    """Extend requests and responses of core Hypernet OpenStack API controllers.
    Provide a way to add data to responses and handle custom request data
    that is sent to core Hypernet OpenStack API controllers.
    """
...
class ActionExtension(object):
    """Add custom actions to core Hypernet OpenStack API controllers."""
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in Hypernet."""
...
# of hypernet_agentless.server.extensions
def get_extensions_path():
    paths = ':'.join(hypernet_agentless.server.extensions.__path__)
