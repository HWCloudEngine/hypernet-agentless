...
"""
Command-line interface to the Hypernet APIs
"""
...
from hypernet_agentless.client.common import clientmanager
from hypernet_agentless.client.common import command as openstack_command
from hypernet_agentless.client.common import exceptions as exc
from hypernet_agentless.client.common import extension as client_extension
...
COMMAND_V1 = {
    ...
    'providerport-list': providerport.ProviderportList,
...
class HypernetShell(app.App):
    ...
    def __init__(self, apiversion):
        super(HypernetShell, self).__init__(
            description=__doc__.strip(),
            version=VERSION,
            command_manager=commandmanager.CommandManager('hypernet.cli'), )
        ...
        # Pop the 'complete' to correct the outputs of 'hypernet help'.
    ...
    def _append_global_identity_args(self, parser):
        ...
        parser.add_argument(
            '--insecure',
            action='store_true',
            default=env('HYPERNETCLIENT_INSECURE', default=False),
            help=_("Explicitly allow hypernetclient to perform \"insecure\" "
    ...
    def _extend_shell_commands(self, module, version):
        ...
        for cls_name, cls in classes:
            if (issubclass(cls, client_extension.HypernetClientExtension) and
    ...
    def initialize_app(self, argv):
        ...
        * validate authentication info
        ...
        super(HypernetShell, self).initialize_app(argv)

        self.api_version = {'hypernet':
                            self.api_version}
...
def main(argv=sys.argv[1:]):
    try:
        return HypernetShell(HYPERNET_API_VERSION).run(
            list(map(utils.safe_decode, argv)))
    except KeyboardInterrupt:
        print("... terminating hypernet client", file=sys.stderr)
        return 130
    except exc.HypernetClientException:
        return 1
    except Exception as e:
        print(e)
        return 1
