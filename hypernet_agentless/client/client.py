...
if os.environ.get('HYPERNETCLIENT_DEBUG'):
...
class HTTPClient(object):
    ...
    USER_AGENT = 'python-hypernetclient'
    ...
    def _get_endpoint_url(self):
        ...
        try:
            ...
            # rollback to authenticate() to handle case when hypernet client
...
def construct_http_client(username=None,
    ...
    if session:
        kwargs.setdefault('user_agent', 'python-hypernetclient')
